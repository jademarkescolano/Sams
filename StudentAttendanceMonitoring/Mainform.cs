...
namespace StudentAttendanceMonitoring
{
    public partial class Mainform : Form
    {
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            if (!panel2.Controls.Contains(AttendanceRecord.Instance))
            {
                panel2.Controls.Add(AttendanceRecord.Instance);
                AttendanceRecord.Instance.Dock = DockStyle.Fill;
                AttendanceRecord.Instance.BringToFront();
                AttendanceRecord.Instance.txtrefresh.PerformClick();
            }
            else
            {
                AttendanceRecord.Instance.BringToFront();
